...
$jan    = $r1['jan']; $feb    = $r1['feb']; $mar    = $r1['mar']; $apr    = $r1['apr']; $mei    = $r1['mei']; $jun    = $r1['jun'];
$jul    = $r1['jul']; $agu    = $r1['agu']; $sep    = $r1['sep']; $okt    = $r1['okt']; $nov    = $r1['nov']; $des    = $r1['des'];
